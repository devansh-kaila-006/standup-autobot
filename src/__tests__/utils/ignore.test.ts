    ...
    describe('isIgnored', () => {
        describe('path normalization', () => {
            it('should normalize Windows backslashes to forward slashes', () => {
                ...
                expect(isIgnored(filePath, patterns)).toBe(true);
            });
        ...
        describe('extension wildcards', () => {
            ...
            it('should not match if extension is different', () => {
                ...
                expect(isIgnored(filePath, patterns)).toBe(false);
            });
            ...
            it('should match multiple extension patterns', () => {
                ...
                expect(isIgnored(filePath1, patterns)).toBe(true);
                expect(isIgnored(filePath2, patterns)).toBe(true);
            });
        });
        ...
        describe('multiple patterns', () => {
            ...
            it('should handle complex pattern combinations', () => {
                ...
                expect(isIgnored('/home/user/project/src/app.ts', patterns)).toBe(false);
                expect(isIgnored('/home/user/project/node_modules/pkg/index.js', patterns)).toBe(true);
                expect(isIgnored('/home/user/project/.git/config', patterns)).toBe(true);
                expect(isIgnored('/home/user/project/error.log', patterns)).toBe(true);
                expect(isIgnored('/home/user/project/dist/main.js', patterns)).toBe(true);
            });
        });
        ...
        describe('real-world scenarios', () => {
            it('should handle common ignore patterns for Node.js projects', () => {
                ...
                expect(isIgnored('/project/node_modules/lodash/index.js', patterns)).toBe(true);
                expect(isIgnored('/project/.git/hooks/pre-commit', patterns)).toBe(true);
                expect(isIgnored('/project/npm-debug.log', patterns)).toBe(true);
                expect(isIgnored('/project/dist/main.js', patterns)).toBe(true);
                expect(isIgnored('/project/.env', patterns)).toBe(true);
                expect(isIgnored('/project/src/app.ts', patterns)).toBe(false);
            });
            ...
            it('should handle common ignore patterns for testing', () => {
                ...
                expect(isIgnored('/project/coverage/lcov-report/index.html', patterns)).toBe(true);
                expect(isIgnored('/project/src/app.test.ts', patterns)).toBe(true);
                expect(isIgnored('/project/src/utils.spec.ts', patterns)).toBe(true);
                expect(isIgnored('/project/__tests__/utils.test.ts', patterns)).toBe(true);
                expect(isIgnored('/project/src/app.ts', patterns)).toBe(false);
            });
        });
    });
