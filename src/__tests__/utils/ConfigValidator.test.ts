...
describe('ConfigValidator', () => {
    describe('validateStandupConfig', () => {
        it('should validate valid configuration', () => {
            ...
            const result = ConfigValidator.validateStandupConfig(validConfig);
        ...
        it('should reject invalid triggerTime format', () => {
            ...
            expect(() => ConfigValidator.validateStandupConfig(invalidConfig))
        ...
        it('should apply defaults for missing fields', () => {
            ...
            const result = ConfigValidator.validateStandupConfig(minimalConfig);
    ...
    describe('validateWorkspaceConfig', () => {
        it('should validate valid workspace configuration', () => {
            ...
            const result = ConfigValidator.validateWorkspaceConfig(validConfig);
        ...
        it('should accept partial workspace configuration', () => {
            ...
            const result = ConfigValidator.validateWorkspaceConfig(partialConfig);
        ...
        it('should reject invalid workspace configuration', () => {
            ...
            expect(() => ConfigValidator.validateWorkspaceConfig(invalidConfig))
                .toThrow(ConfigurationError);
        });
    });
    ...
    describe('validateActivity', () => {
        it('should validate valid activity data', () => {
            ...
            const result = ConfigValidator.validateActivity(validActivity);
        ...
        it('should reject invalid activity type', () => {
            ...
            expect(() => ConfigValidator.validateActivity(invalidActivity))
    ...
    describe('validateConfigValue', () => {
        it('should validate individual valid config value', () => {
            expect(() => ConfigValidator.validateConfigValue('tone', 'casual'))
                .not.toThrow();
        });

        it('should reject individual invalid config value', () => {
            expect(() => ConfigValidator.validateConfigValue('tone', 'invalid'))
                .toThrow(ConfigurationError);
        });

        it('should reject unknown config key', () => {
            expect(() => ConfigValidator.validateConfigValue('unknownKey', 'value'))
                .toThrow(ConfigurationError);
        });
    });
    ...
    describe('sanitizeConfig', () => {
        it('should remove unknown keys from config', () => {
            ...
            const sanitized = ConfigValidator.sanitizeConfig(configWithUnknowns);
        ...
        it('should preserve valid keys', () => {
            ...
            const sanitized = ConfigValidator.sanitizeConfig(validConfig);

            expect(sanitized).toEqual(validConfig);
        });

        it('should handle empty config', () => {
            const sanitized = ConfigValidator.sanitizeConfig({});
    ...
    describe('mergeWithDefaults', () => {
        ...
        it('should handle empty user config', () => {
            ...
            expect(merged).toEqual(ConfigValidator.getDefaults());
        });
...
describe('ConfigMigrator', () => {
    describe('needsMigration', () => {
        it('should return true if version is less than current', () => {
            ...
            const originalVersion = (ConfigMigrator as any).CURRENT_VERSION;
            (ConfigMigrator as any).CURRENT_VERSION = 3;

            const needsMigration = ConfigMigrator.needsMigration();

            expect(needsMigration).toBe(true);

            // Restore
            (ConfigMigrator as any).CURRENT_VERSION = originalVersion;
        });
    });

    describe('getCurrentVersion', () => {
        it('should return current version', () => {
            const version = ConfigMigrator.getCurrentVersion();
    ...
    describe('migrate', () => {
        it('should run migrations to current version', async () => {
            ...
            await expect(ConfigMigrator.migrate()).resolves.not.toThrow();
        });
    });
});
