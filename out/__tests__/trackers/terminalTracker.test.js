    ...
    describe('getTerminalHistory', () => {
        ...
        describe('PowerShell history file exists', () => {
            ...
            it('should handle file read errors gracefully', async () => {
                ...
                expect(consoleSpy).toHaveBeenCalledWith('Error reading PowerShell history:', expect.any(Error));
            ...
            it('should construct correct PowerShell history path', async () => {
                ...
                fs.existsSync.mockReturnValue(true);
                fs.readFileSync.mockReturnValue('command');
                await terminalTracker.getTerminalHistory();
                expect(path.join).toHaveBeenCalledWith('C:\\Users\\testuser', 'AppData', 'Roaming', 'Microsoft', 'Windows', 'PowerShell', 'PSReadline', 'ConsoleHost_history.txt');
            });
        });
        ...
        describe('edge cases', () => {
            ...
            it('should handle limit of 0 (returns all due to slice behavior)', async () => {
                ...
                path.join.mockImplementation((...args) => args.join('/'));
                fs.existsSync.mockReturnValue(true);
                fs.readFileSync.mockReturnValue('command1\ncommand2');
...
//# sourceMappingURL=terminalTracker.test.js.map