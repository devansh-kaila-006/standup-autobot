...
describe('HistoryService', () => {
    ...
    beforeEach(() => {
        ...
        service = new HistoryService_1.HistoryService(mockContext);
    });
    describe('saveStandup', () => {
        it('should save a new standup entry', async () => {
            ...
            const savedHistory = mockContext.globalState.update.mock.calls[0][1];
        ...
        it('should trim history to last 30 days', async () => {
            ...
            expect(savedHistory.every((entry) => entry.timestamp > now - 30 * dayInMs)).toBe(true);
        });
    ...
    describe('getHistory', () => {
        ...
        it('should return existing history', () => {
            ...
            mockContext.globalState.get.mockReturnValue(testHistory);
            const history = service.getHistory();
    ...
    describe('logActivity', () => {
        it('should create new activity entry for today', async () => {
            ...
            expect(mockContext.globalState.update).toHaveBeenCalledWith('standup.activityDaily', expect.any(Array));
            const savedActivity = mockContext.globalState.update.mock.calls[0][1];
    ...
    describe('getAllActivity', () => {
        ...
        it('should return existing activity', () => {
            ...
            mockContext.globalState.get.mockReturnValue(testActivity);
            const activity = service.getAllActivity();
