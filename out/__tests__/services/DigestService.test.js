...
describe('DigestService', () => {
    ...
    const createMockEntry = (text, timestamp) => ({
        id: '1',
    ...
    describe('generateWeeklyDigest', () => {
        it('should return error message when history has fewer than 3 entries', async () => {
            ...
            const result = await DigestService_1.DigestService.generateWeeklyDigest(history, mockGenerator, 'test-api-key');
        ...
        it('should format history entries with dates and notes', async () => {
            ...
            await DigestService_1.DigestService.generateWeeklyDigest(history, mockGenerator, 'test-api-key');
        ...
        it('should pass API key to generator', async () => {
            ...
            mockGenerator.generateContent.mockResolvedValue('Summary');
            await DigestService_1.DigestService.generateWeeklyDigest(history, mockGenerator, apiKey);
...
//# sourceMappingURL=DigestService.test.js.map